      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {projects.map((p) => (
            <article
              key={p.name}
              className="group flex flex-col overflow-hidden rounded border border-[#233554] bg-[#112240] transition-all duration-200 hover:border-[#64FFDA]/40 hover:-translate-y-1"
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {p.stack.map((tech) => (
                    <span
                      key={tech}
                      className="font-mono text-xs text-[#64FFDA]"
                    >
                      {tech}
                    </span>
                  ))}
